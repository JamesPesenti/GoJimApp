   ...
   return (
     <>
       <View style={styles.container}>
           ...
           <Text style={{    alignItems: 'flex-start', color: "white", fontWeight: "bold", fontSize: 18, marginBottom: 0 }}>{title}</Text>
             <View style={styles.goalContainer}>
                <Text style={{   alignItems: 'flex-start', color: "white", fontSize: 15, fontWeight: "bold" }}>{goalProgress} LB</Text>
