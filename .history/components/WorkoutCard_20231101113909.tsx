       ...
       <View style={styles.container}>
           {/* <DollarSign style={{marginTop: -20}} size={29} color={"gray"} /> */}
             <View style={styles.goalContainer}>
                <Text style={{ textAlign: "center", color: "gray", fontWeight: "bold", fontSize: 20, marginBottom: -5, marginRight: 5, }}>{title}</Text>
                <Text style={{ textAlign: "center", fontSize: 22, fontWeight: "bold" }}>{goalProgress}</Text>
