...
export default function WorkoutCard ({ item, totalExercises, totalSets, totalReps, totalWeight }) {
  ...
  const iconMap = {
    Exercise: <Dumbbell strokeWidth={1} style={{ transform: [{rotate: '0deg'}]}} size={30} color="#00FFFF" />,
                    ...
                    renderItem={({item}) => {
                      return (
                        <>
                          ...
                          <Text style={{ color: "white", fontWeight: "bold", fontSize: 14, marginBottom: 0 }}>{item.notes}</Text>
                              <Text style={{fontSize: 15, alignSelf: 'flex-start', color: "#00FFFF",}}>{item.notes}</Text>
