                ...
                <View style={styles.gridContainer}>
                  <FlatList 
                    ...
                    renderItem={({item}) => {
                      return (
                        <>
                          <Coins size={30} color={"#00FFFF"} />
                            <View style={{flex: 0.45, marginVertical: 10, marginHorizontal: 0, backgroundColor: "#031088",}}>
                              <Text style={{fontSize: 12, alignSelf: 'flex-start', color: "#00FFFF",}}>{item.num}</Text>
