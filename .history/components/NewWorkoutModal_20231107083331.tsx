import { 
 ...
 const NewWorkoutModal = ({ visible, onSubmit, onClose }) => {
   ...
   const handleSubmit = () => {
     ...
     onSubmit(warmup, notes, workout, lbs, setsRepstitle)
     setWarmup("")
     setNotes("")
     setWorkout("")
     setLbs("")
      ...
      <StatusBar hidden />
       <Modal visible={visible} animationType='fade' >
        <View style={styles.textInputContainer}>
           ...
           <View style={{ marginBottom: 20, borderBottomWidth: .9, borderColor: 'gray'}}>
             <TextInput
               placeholder='Warm Up' 
           ...
           <View style={{ marginBottom: 20, borderBottomWidth: 1.2, borderColor: 'gray'}}>
             <TextInput
               placeholder='Notes' 
               placeholderTextColor='#bfbfbf' 
               value={notes}
        ...
        <View style={styles.buttonContainer}>
         ...
         {workout.trim() || lbs.trim() || setsReps.trim() ? (
           <Pressable 
             onPress={onClose}
             style={styles.button}
           >
