...
import { Dumbbell, GanttChartSquare, Repeat, Heart, Circle, Square  } from 'lucide-react-native';
...
export default function WorkoutCard ({ item, onPress }) {
  ...
  const iconMap = {
    Exercises: <Dumbbell strokeWidth={1} style={{ transform: [{rotate: '15deg'}]}} size={30} color="#00FFFF" />,
    Sets: <GanttChartSquare  strokeWidth={1} size={30} color="#00FFFF" />, 
    Reps: <Repeat  strokeWidth={1} size={30} color="#00FFFF" />, 
    'Weight Lifted': <Square  strokeWidth={1} size={30} color="#00FFFF" />, 
  };
