   ...
   return (
     <>
       <View style={styles.container}>
           ...
           <Text style={{ color: "white", fontWeight: "bold", fontSize: 18, marginBottom: 0 }}>{warmup}</Text>
           <Text style={{ color: "white", fontWeight: "bold", fontSize: 18, marginBottom: 0 }}>{notes}</Text>
