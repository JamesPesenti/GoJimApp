...
const TodaysWorkout = () => {
   ...
   const findExercise = async () => {
     ...
     if (result !== null) setExercises(JSON.parse(result));
   }
    ...
    <View>
      <FlatList
         ...
         data={exercises.map((exercise) => ({
          ...
          type: exercise.type, // Change this to the actual property name in your exercise object
          num: exercise.num, // Change this to the actual property name in your exercise object
        }))}
