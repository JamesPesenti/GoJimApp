...
import { Dumbbell, GanttChartSquare, Heart, Circle, Square  } from 'lucide-react-native';
...
export default function WorkoutCard ({ item, onPress }) {
  ...
  const iconMap = {
    Exercises: <Dumbbell style={{right: 20, transform: [{rotate: '15deg'}]}} size={30} color="#00FFFF" />,
    Sets: <GanttChartSquare size={30} color="#00FFFF" />, 
    Reps: <Circle size={30} color="#00FFFF" />, 
