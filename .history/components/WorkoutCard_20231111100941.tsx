...
export default function WorkoutCard ({ item, onPress, onUpdate, data }) {
                        ...
                        <>
                          {iconMap[item.type]} 
                            <View style={{flex: 1, marginHorizontal: 10, backgroundColor: "#031088",}}>
                              <Text style={{fontSize: 18, alignSelf: 'flex-start', color: "#00FFFF",}}>{item.notes}</Text>
                              <Text style={{color: "white"}}>{item.workout}</Text>
