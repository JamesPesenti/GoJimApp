...
export default function WorkoutCard ({ item, totalExercises, totalSets, totalReps, totalWeight }) {
   ...
   const data = [
    {
      "id": "1",
      "type": "Exercises",
      "num": totalExercises.toString()
    },
    {
      "id": "2",
      "type": "Sets",
      "num": totalSets.toString()
    },
    {
      "id": "3",
      "type": "Reps",
      "num": totalReps.toString()
    },
    {
      "id": "4",
      "type": "Weight Lifted",
      "num": totalWeight.toString()
    }
  ]

  const iconMap = {
    Exercises: <Dumbbell strokeWidth={1} style={{ transform: [{rotate: '0deg'}]}} size={30} color="#00FFFF" />,
    Sets: <GanttChartSquare  strokeWidth={1} size={30} color="#00FFFF" />, 
    Reps: <Repeat  strokeWidth={1} size={30} color="#00FFFF" />, 
    'Weight Lifted': <Weight  strokeWidth={1} size={30} color="#00FFFF" />, 
  };
   ...
   return (
     <>
       <View style={styles.container}>
           ...
           <Text style={{ color: "white", fontWeight: "bold", fontSize: 14, marginBottom: 0 }}>Warmup </Text>
                      ...
                      return (
                        <>
                          ...
                          <View style={{flex: 1, marginHorizontal: 10, backgroundColor: "#031088",}}>
                              <Text style={{fontSize: 18, alignSelf: 'flex-start', color: "#00FFFF",}}>{item.workout}</Text>
